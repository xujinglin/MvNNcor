...
class HandwrittenAttrData(object):
    """
        Dataloader for Handwritten datasets
    """

    def __init__(self, data_dir='/home/xujinglin/Downloads/mvdata-master/datasets/Handwritten.mat',
                mode='train'):

        super(HandwrittenAttrData, self).__init__()
