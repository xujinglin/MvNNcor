...
class NUSWIDEAttrData(object):
    """
        Dataloader for NUSWIDEOBJ datasets
    """

    def __init__(self, data_dir='/home/xujinglin/Downloads/mvdata-master/datasets/NUSWIDEOBJ.mat',
                mode='train'):

        super(NUSWIDEAttrData, self).__init__()
